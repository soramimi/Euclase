...
struct CUDAIMAGE_API {
	...
	void (*blend_fp32_RGBA)(int w, int h, cudamem_t const *src, int src_w, int src_h, int sx, int sy, cudamem_t const *mask, int mask_w, int mask_h, cudamem_t *dst, int dst_w, int dst_h, int dx, int dy);
	void (*blend_fp16_RGBA)(int w, int h, cudamem_t const *src, int src_w, int src_h, int sx, int sy, cudamem_t const *mask, int mask_w, int mask_h, cudamem_t *dst, int dst_w, int dst_h, int dx, int dy);
	void (*erase_fp32_RGBA)(int w, int h, cudamem_t const *src, int src_w, int src_h, int sx, int sy, cudamem_t const *mask, int mask_w, int mask_h, cudamem_t *dst, int dst_w, int dst_h, int dx, int dy);
	void (*erase_fp16_RGBA)(int w, int h, cudamem_t const *src, int src_w, int src_h, int sx, int sy, cudamem_t const *mask, int mask_w, int mask_h, cudamem_t *dst, int dst_w, int dst_h, int dx, int dy);
	...
	void (*compose_fp32_rgba)(int w, int h, cudamem_t *dst, cudamem_t const *src, cudamem_t const *mask);
	void (*compose_fp16_rgba)(int w, int h, cudamem_t *dst, cudamem_t const *src, cudamem_t const *mask);
	void (*scale_fp32_to_uint8_rgba)(int dw, int dh, int dstride, cudamem_t *dst, int sw, int sh, cudamem_t const *src);
	void (*scale_fp16_to_uint8_rgba)(int dw, int dh, int dstride, cudamem_t *dst, int sw, int sh, cudamem_t const *src);
